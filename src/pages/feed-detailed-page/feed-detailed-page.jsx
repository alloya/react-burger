...
import { countBasket, getDate, sortIngredients } from "../../utils/utils";
  ...
  return (
    <>
      {order && <div className={s.container + ' text text_type_main-medium'}>
        <span className="text text_type_digits-default mt-5"># {order.number} </span>
        <p className={styles.mr_auto + " text text_type_main-medium pb-2 mt-10"}>{order.name}</p>
        <p className={styles.mr_auto + " text text_type_main-default mb-15"}>{order.status}</p>
